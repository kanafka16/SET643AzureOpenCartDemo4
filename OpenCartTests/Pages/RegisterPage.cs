...
namespace OpenCartTests.Pages
{
    public class RegisterPage : AUnloggedRightMenuComponent
    {
        ...
        public IWebElement ExistingEmailWarningMessage { get { return driver.FindElement(By.CssSelector("div.alert.alert-danger.alert-dismissible")); } }
        ...
        public string GetExistingEmailWarningMessage() => ExistingEmailWarningMessage.Text;
